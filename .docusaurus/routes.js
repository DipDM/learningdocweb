        ...
        routes: [
          {
            ...
            routes: [
              ...
              },
              {
                ...
                component: ComponentCreator('/docs/SQL/chapter/chapter-12', 'd56'),
                exact: true,
                sidebar: "learningSidebar"
              },
              {
                path: '/docs/SQL/chapter/chapter-13',
                component: ComponentCreator('/docs/SQL/chapter/chapter-13', 'b05'),
                exact: true,
                sidebar: "learningSidebar"
              },
              {
                path: '/docs/SQL/chapter/chapter-14',
                component: ComponentCreator('/docs/SQL/chapter/chapter-14', '4d5'),
                exact: true,
                sidebar: "learningSidebar"
              },
              {
                path: '/docs/SQL/chapter/chapter-15',
                component: ComponentCreator('/docs/SQL/chapter/chapter-15', 'ba7'),
                exact: true,
                sidebar: "learningSidebar"
              },
              {
